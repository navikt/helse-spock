...
class SpesialistPåminnelseDao(private val dataSource: DataSource) {
    ...
    fun finnEllerOpprettPåminnelse(referanse: String, fødselsnummer: String, endringstidspunkt: LocalDateTime, timeout: Long) {
    ...
    fun finnPåminnelse(referanse: String) = using(sessionOf(dataSource)) { session ->
